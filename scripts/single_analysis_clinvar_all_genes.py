#!/usr/bin/env python3
"""Validate PLM-derived single-mutation scores against ClinVar annotations.

This script builds a mutation-level table from pairwise epistasis outputs,
merges it with a ClinVar TSV, and generates summary tables and figures.
"""
...
def merge_one_gene(base_dir, gene):
    ...
    epi_path = find_file_case_insensitive(gene_dir, gene, ["_epistasis_esmcnd.tsv"])
