#!/usr/bin/env python3
"""Validate PLM-derived single-mutation scores against VEP SIFT/PolyPhen annotations.

This script extracts single-mutation scores from pairwise epistasis outputs,
parses per-gene VEP VCF files, and compares PLM scores across SIFT and
PolyPhen prediction classes.
"""
...
def main():
    parser = argparse.ArgumentParser(
        description="Validate single-mutation scores against VEP SIFT and PolyPhen annotations."
    )
